...
@section('title','Login ')
@section('subtitle','Log in with your data that you entered during registration.')
...
<div class="text-center mt-5 text-lg fs-4">
    ...
    <p class="text-gray-600">Don't have an account? <a href="{{ route('register') }}" class="font-bold">{{ __('Register') }}</a>.
    </p>
    @endif
